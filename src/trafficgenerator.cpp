...
void TrafficGenerator::GenerateVehicle(){
    ...
    case 2:
        {
        std::shared_ptr<Vehicle> _car = std::shared_ptr<Vehicle>(new Vehicle(Vehicle::VehicleType::Car,screen_width,screen_height,0,-120,45,80));
    ...
    case 4:
        {
        std::shared_ptr<Vehicle> _taxi = std::shared_ptr<Vehicle>(new Vehicle(Vehicle::VehicleType::Taxi,screen_width,screen_height,0,-120,50,77));
